...
- [x] v0.6.7 签名发布及公开资产复验：source `bb85f954889ead4b6894a9a258ea1299884050a5`，Release `383348682`，CI `33985881583`、release `33985887656`、公开复验 `33986855993` 全部成功；[证据](validation/release-v0.6.7.md)。
